...
public class GemOreBlockOLD extends Block implements ISpriteAtlasBlock {

	private SpriteAtlas spriteAtlas;
	private final Item[] breakResult;
	public GemOreBlockOLD(String key, int id, Material material, SpriteAtlas spriteAtlas, Item[] breakResult) {
	...
	@Override
	public GemOreBlockOLD setSpriteCoord(int side, int x, int y) {
