...
public class GemToolAxeItem extends ItemToolAxe implements IColored, ISpriteAtlasItem {

	private SpriteAtlas spriteAtlas;
	private final int color;
	private final int[] coordOverlay = new int[2];

	public GemToolAxeItem(String name, int id, ToolMaterial enumtoolmaterial, SpriteAtlas spriteAtlas, int color) {
	...
	@Override
	public GemToolAxeItem setSpriteCoord(int x, int y) {
		this.iconIndex = this.spriteAtlas.spriteCoordToIndex(x, y);
		return this;
	}

	public GemToolAxeItem setOverlayCoord(int x, int y) {
		coordOverlay[0] = x;
		coordOverlay[1] = y;
		return this;
	}
